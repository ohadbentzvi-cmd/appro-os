        ...
        return (
            <div className="max-w-5xl mx-auto pb-12">
                <nav className="flex items-center text-sm font-medium text-gray-500 mb-8 mt-2">
                    <Link href="/dashboard/people" className="hover:text-apro-navy transition-colors">
                        אנשים
                    </Link>
                ...
                <div className="p-10 flex flex-col items-center text-center gap-4 bg-white rounded-2xl shadow-sm border border-red-100">
                    ...
                    <div className="max-w-md">
                        ...
                        <Link href="/dashboard/people" className="text-apro-green hover:underline font-bold">
                            חזרה לרשימת האנשים
                        </Link>
                    </div>
                </div>
