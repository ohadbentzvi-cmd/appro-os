    ...
    return (
        <>
            <header className="mb-8 flex justify-between items-start">
                <div>
                    <h1 className="text-3xl font-bold text-apro-navy mb-2">תשלומים וחיובים</h1>
                    <p className="text-gray-500 font-medium">ניהול חיובים וצפייה בהיסטוריית הפקות</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-8">
                <div className="px-6 py-5 border-b border-gray-100 flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-bold text-apro-navy">היסטוריית הפקת חיובים</h2>
                </div>
